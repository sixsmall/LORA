...
int main()
 {
	   ...
	   SX1278_LoRaEntryRx(&SX1278, nLoRaSendBuffLength, 1000);  
...
//		 开启定时器，2s发送一次数据  
		...
		{
		  sendtimeflag = 0;
		  SX1278_LoRaEntryTx(&SX1278, nLoRaSendBuffLength, 1000);
	      SX1278_LoRaTxPacket(&SX1278,LoRaNodeSendDataBuf, nLoRaSendBuffLength,1000);  
		}
