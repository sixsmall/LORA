...
#ifdef  LPUART_GLOBALS
#define LPUART_EXT
#else
#define LPUART_EXT  extern
#endif
...
LPUART_EXT uint8_t u8RxData[10][20];
LPUART_EXT uint8_t lpuartbuffstart;
LPUART_EXT uint8_t lpuartbuffend;
	
LPUART_EXT uint8_t sendcountstart;
	
LPUART_EXT uint8_t u8RxFlg;
LPUART_EXT uint8_t onceflag;

LPUART_EXT uint8_t lpuartflag;
LPUART_EXT uint8_t receivenum;
LPUART_EXT uint8_t aaflag;
