...
WDT_EXT uint8_t sendddata[10][20];
WDT_EXT uint8_t lorasendstart;
WDT_EXT uint8_t lorasendend;
WDT_EXT uint8_t wdtflag;
WDT_EXT uint8_t debugflag;
WDT_EXT uint8_t debugcount;
