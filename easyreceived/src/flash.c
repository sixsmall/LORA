...
//写FALSH
 void FlashWriteNodeID()
 {
   
       Flash_SectorErase(0x3ff0);
    
	  //公司类型
		Flash_WriteByte(0x3ff0,0x1A);
		Flash_WriteByte(0x3ff1,0x0A);
	  //网络类型
		Flash_WriteByte(0x3ff2,0x42);
	  //日期
		Flash_WriteByte(0x3ff3,0x20);
		Flash_WriteByte(0x3ff4,0x01);
		Flash_WriteByte(0x3ff5,0x02);
	  //装配地
	    Flash_WriteByte(0x3ff6,0x01);
	  //流水线
		Flash_WriteByte(0x3ff7,0x01);
	  //序列号
		Flash_WriteByte(0x3ff8,0x00);
		Flash_WriteByte(0x3ff9,0x00);
		Flash_WriteByte(0x3ffa,0x36);
	  //类型码
		Flash_WriteByte(0x3ffb,0x00);
	    Flash_WriteByte(0x3ffc,0x04);

 }
 
void FlashWriteControllerID()
{
    Flash_SectorErase(0x4ff0);
	 
//		//公司类型
//		Flash_WriteByte(0x4ff0,0x1A);
//		Flash_WriteByte(0x4ff1,0x0A);
//	  //网络类型        
//		Flash_WriteByte(0x4ff2,0x42);
//	  //日期            
//		Flash_WriteByte(0x4ff3,0x02);
//		Flash_WriteByte(0x4ff4,0xEA);
//		Flash_WriteByte(0x4ff5,0x92);
//	  //装配地          
//	  Flash_WriteByte(0x4ff6,0x01);
//	  //流水线          
//		Flash_WriteByte(0x4ff7,0x01);
//	  //序列号          
//		Flash_WriteByte(0x4ff8,0x00);
//		Flash_WriteByte(0x4ff9,0x00);
		Flash_WriteByte(0x4ffa,0x03);
//	  //类型码          
//		Flash_WriteByte(0x4ffb,0x00);
	  Flash_WriteByte(0x4ffc,0x15);
}                     
