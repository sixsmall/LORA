 ...
 ******************************************************************************/
func_ptr_t pfnLpTimCallback = NULL;

uint8_t u32LptFlag = 0;
uint32_t count = 0;
uint8_t test = 0;
uint8_t test1 = 0;
uint8_t LptFlaggongzhuang = 0;
/*******************************************************************************
...
//		  Lpt_Stop();
//		  receivenum  = 0;
//		  memset(u8RxData[lpuartbuffstart],0,20);
//	    }
}


//lptime初始化
void LPTIME_INIT(void)
{
	  stc_lpt_config_t stcConfig;
	  en_result_t      volatile enResult = Error;
